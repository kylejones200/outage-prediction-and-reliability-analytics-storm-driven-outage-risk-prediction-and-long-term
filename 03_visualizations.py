...
def generate_outage_architecture(plot: bool = False):
    ...
    if plot:
        ...
        ax.text(
            5.5,
            9.3,
            "Outage Detection & Analysis Architecture",
            ha="center",
            fontsize=14,
            weight="bold",
        )
...
def generate_outage_dashboard(plot: bool = False):
    ...
    if plot:
        ...
        ax1.bar(
            ...
            events_major,
            width=20,
            bottom=events_critical,
            label="Major (100k-500k)",
            color="#696969",
            edgecolor="black",
            linewidth=1,
        )
        ...
        ax2_1.bar(
            x - width / 2,
            [c / 1000000 for c in total_customers_out],
            width,
...
def generate_temporal_patterns(plot: bool = False):
    ...
    if plot:
        ...
        ax1.set_title(
            "Hourly Outage Pattern with Confidence Intervals",
            fontsize=12,
            weight="bold",
        )
